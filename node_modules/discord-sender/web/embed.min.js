...
/*fetch*/
axios.get(`https://ws.is-a.dev/embed?channel=${channel}${title}${color}${url}${thumbnail}${author}${authorIcon}${authorUrl}${image}${description}`)

return ('Embed Send !')
}
const oo = '{"title": "joe", "url":"https://discord.is-a.dev","description":"ok"}'
embed('705036476584296500', oo);
